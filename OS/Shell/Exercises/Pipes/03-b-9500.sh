...
cp /srv/fmi-os/exercises/data/ssa-input.txt ~/ssa
...
grep -E "(Array|physicaldrive|Temperature)" ssa | sed 's/^[ ]*//g' | awk -F ' ' 'BEGIN{arr} {if($1=="Array") {arr=$2} else if($1=="physicaldrive") {print arr"-"$2;} else if($2=="Temperature") {print $4;} }'
